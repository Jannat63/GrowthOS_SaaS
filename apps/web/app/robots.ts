...
// should never appear in search results at all. The onboarding steps are listed for the same
// reason: they are reachable URLs that render nothing without a session.
