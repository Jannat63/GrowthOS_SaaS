...
import type { CampaignInsight } from "@growthos/logic";
      ...
      {!d ? (
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Tile label="Total spend" value={usd(d.summary.totalSpend)} />
            <Tile label="Blended ROAS" value={`${d.summary.blendedRoas.toFixed(2)}x`} />
            <Tile label="Wasted campaigns" value={d.summary.wastedCount} />
            <Tile label="Scale opportunities" value={d.summary.scaleCount} />
          </div>

          {d.wastedSpend.length > 0 && (
