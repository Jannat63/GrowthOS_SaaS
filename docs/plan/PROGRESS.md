...
**M5 started** — P5.1 Billing core, P5.2 Plan limits & metering, and P5.3 Customer portal &
lifecycle emails done; P5.4 not started.
...
## M5 — Launch & Monetization  🟨 In progress — P5.1, P5.2, P5.3 done (see docs/plan/M5-launch-monetization/progress.md)
