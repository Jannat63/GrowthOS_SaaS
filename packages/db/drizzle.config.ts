...
export default defineConfig({
  ...
  schema: ['./src/schema/auth.ts', './src/schema/tenancy.ts', './src/schema/jobs.ts', './src/schema/onboarding.ts', './src/schema/recommendations.ts', './src/schema/content-briefs.ts'],
  out: './drizzle',
  dbCredentials: {
