...
export default defineConfig({
  ...
  schema: ['./src/schema/auth.ts', './src/schema/tenancy.ts', './src/schema/jobs.ts', './src/schema/onboarding.ts', './src/schema/recommendations.ts', './src/schema/content-briefs.ts', './src/schema/intelligence.ts', './src/schema/collaboration.ts', './src/schema/audit.ts'],
  out: './drizzle',
  dbCredentials: {
